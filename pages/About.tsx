      ...
      <section className="px-6 max-w-7xl mx-auto mb-24">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            <div className="order-2 md:order-1">
                <h1 className="text-5xl md:text-7xl font-bold mb-8">{SITE_CONTENT.about.title}</h1>
                <div className="space-y-6 text-lg text-neutral-400 leading-relaxed">
                    {SITE_CONTENT.about.bioParagraphs.map((para, i) => (
                      <p key={i}>{para}</p>
                    ))}
                </div>
            ...
            <div className="order-1 md:order-2 relative">
                <div className="aspect-[3/4] rounded-3xl overflow-hidden bg-neutral-900 relative">
                    ...
                    <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black to-transparent p-8">
                        <p className="text-white font-bold text-xl">{SITE_CONTENT.name}</p>
                        <p className="text-neutral-400 text-sm">{SITE_CONTENT.role}</p>
                    </div>
                </div>
            </div>
        </div>
      ...
      <section className="bg-neutral-900 py-20 mb-24">
          <div className="max-w-7xl mx-auto px-6 grid grid-cols-2 md:grid-cols-4 gap-8">
            <div className="text-center">
                ...
                <h3 className="text-3xl font-bold text-white mb-1">{SITE_CONTENT.about.stats.yearsExp}</h3>
            ...
            <div className="text-center">
                ...
                <h3 className="text-3xl font-bold text-white mb-1">{SITE_CONTENT.about.stats.projects}</h3>
            ...
            <div className="text-center">
                ...
                <h3 className="text-3xl font-bold text-white mb-1">{SITE_CONTENT.about.stats.turnaround}</h3>
            ...
            <div className="text-center">
                ...
                <h3 className="text-3xl font-bold text-white mb-1">{SITE_CONTENT.about.stats.awards}</h3>
